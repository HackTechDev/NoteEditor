...
- Aperçu Markdown en volet séparé pour les fichiers `.md` / `.markdown` (icône de la barre d'outils, désactivée pour les autres onglets) : le rendu, mis à jour en direct pendant la frappe et mis en forme (fonds pour le code et les citations, bordures pour les tableaux et les titres), s'affiche à droite de l'éditeur et suit son défilement ; « Fichier → Exporter en HTML... » enregistre le rendu, avec la même mise en forme, dans une page HTML autonome

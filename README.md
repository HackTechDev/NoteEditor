...
- Menu Fichier → « Notes fermées récemment » : les 10 dernières notes fermées (y compris les fichiers extérieurs qui ne figurent plus dans le panneau), à rouvrir en un clic ; la liste est mémorisée d'un lancement à l'autre ; une note vide sans fichier n'y figure que si l'on coche « Mémoriser à la fermeture » dans son menu contextuel
